...
class ProductController extends Controller
{
    ...
    {
        $attributeFactors = $request->input('attributeValueFactor');

        foreach ($attributeFactors as $attributeValueId => $attributeFactor) {

            $this->attributeValueRepository->updateAttributeValue($attributeValueId, array('factor'=> $attributeFactor));

        }

        return redirect()->route('admin.products.edit', $id)
            ->with('message', 'Attribute factors has been saved.');
    }
