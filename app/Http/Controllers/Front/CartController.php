...
class CartController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('front.carts.cart', $data);
    }
    ...
    public function store(AddToCartRequest $request)
    {
        ...
        // Add custom price to the cart price
        $product->price = $request->input('final_price');
        $this->cartRepo->addToCart($product, $request->input('quantity'),['art_upload'=>$request->input('art_upload')]);
