...
class BankTransferController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $os = $orderStatusRepo->findByName('Processing');
        ...
        //$data = ['message'=>'You will get the bank details in the follow-up email.'];
        $message = 'You will get the bank details in the follow-up email.';
        return view('front.checkout-success')->with('message', $message);
    }
}