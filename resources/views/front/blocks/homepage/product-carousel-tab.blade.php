<section class="products-carousel-tabs animate-in-view fadeIn animated" data-animation="fadeIn">
	...
	<ul class="nav nav-inline">
		...
		<li class="nav-item">
			<a class="nav-link" href="#tab-products-2" data-toggle="tab">New</a>
		</li>
	...
	<div class="tab-content">
			...
			<section class="section-products-carousel" >
				<div class="home-v2-owl-carousel-tabs">
					<div class="woocommerce columns-3">
						@include('front.components.product-carousel-item-features')
					</div>
				</div>
			</section>
		</div><!-- /.tab-pane -->
		...
		<div class="tab-pane" id="tab-products-2" role="tabpanel">
			<section class="section-products-carousel">
				<div class="home-v2-owl-carousel-tabs">
					<div class="woocommerce columns-3">
						@include('front.components.product-carousel-item-new')
					</div>
				</div>
			</section>
		</div><!-- /.tab-pane -->
		...
		<div class="tab-pane" id="tab-products-3" role="tabpanel">
			<section class="section-products-carousel">
				<div class="home-v2-owl-carousel-tabs">
					<div class="woocommerce columns-3">
						@include('front.components.product-carousel-item-toprated')
					</div>
				</div>
			</section>
		</div><!-- /.tab-pane -->
