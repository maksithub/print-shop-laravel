    ...
    <section class="container content">
        ...
        <div class="box">
            <form action="{{ route('customer.address.store', $customer->id) }}" method="post" class="form" enctype="multipart/form-data">
                ...
                <input type="hidden" name="addressType" value="<?php echo isset($_GET['addressType'])?$_GET['addressType']:'billing'; ?>">
                <input type="hidden" name="addressType" value="<?php echo isset($_GET['addressType'])?$_GET['addressType']:'billing'; ?>">
                <div class="box-body">
                    {{ csrf_field() }}
...
<!--                     <div id="provinces" class="form-group" style="display: none;"></div>
                ...
                <div class="box-footer">
                    <div class="btn-group">
                        <a href="{{ route('accounts') }}" class="btn btn-default">Back</a>
            ...
            $.ajax({
                ...
                success: function (res) {
                    if (res.data.length > 0) {
                        ...
                        $('#provinces').html("Its test for now").show();
                        $('.select2').select2();
