                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <ul class="nav nav-tabs" role="tablist" id="tablist">
                                ...
                                <li role="presentation" @if(request()->has('combination')) class="active" @endif><a href="#combinations" aria-controls="profile" role="tab" data-toggle="tab">Attribute</a></li>
                            </ul>
                            <!-- Tab panes -->
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control ckeditor" name="shortdescription" id="shortdescription" rows="6" placeholder="Short Description">{!! $product->shortdescription  !!}</textarea>
                                            </div>
                                            <div class="form-group">
...
<!--                                             <div class="form-group">
                                ...
                                <div role="tabpanel" class="tab-pane @if(request()->has('combination')) active @endif" id="combinations">
                                    <div class="row">
                                        <div class="col-md-4">
                                            @include('admin.products.attribute-factors', ['productID'=>$product->id, 'attributes' => $attributes])
                                        </div>
                                        <div class="col-md-8">
                                            @include('admin.products.attributes', ['productID'=>$product->id, 'attributes' => $attributes])
                                        </div>
                                    </div>
                                </div>
                            </div>
