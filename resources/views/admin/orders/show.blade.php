                ...
                @if(!$items->isEmpty())
                    <div class="box-body">
                        ...
                        <table class="table">
                            ...
                            <th class="col-md-2">Art upload</th>
                            </thead>
                            <tbody>
                            @foreach($items as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->price }}</td>
                                    <td><a href="{{ asset($item->pivot->art_upload) }}" target="_blank">See attached file</a>--<a href="{{ asset($item->pivot->art_upload) }}" download>Download</a></td>
                                </tr>
                            @endforeach
                            </tbody>
                        </table>
